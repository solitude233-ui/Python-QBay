...
def test_create_product():
    ...
    while k <= 80:
        test_title_4 += "a"
        k += 1
    create_product(test_title_4, correct_description,
                   correct_price, correct_date, correct_email)
    ...
    while i < 20:
        test_des_1 += "a"
        i += 1
    create_product(correct_title, test_des_1,
                   correct_price, correct_date, correct_email)
    ...
    while j < 2002:
        test_des_2 += "a"
        j += 1
    create_product(correct_title, test_des_2,
                   correct_price, correct_date, correct_email)
    # Test when description is shorter than title
    test_des_3 = "smartwatc"
    create_product(correct_title, test_des_3,
                   correct_price, correct_date, correct_email)
    ...
    new_user = register(correct_email, sample_password)
